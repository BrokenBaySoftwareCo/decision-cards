...
var preact = createCommonjsModule(function (module, exports) {
  var e,
    t = ((e = require$$0) && "object" == typeof e && "default" in e
      ? e.default
      : e
    ).bind(preact_module.h);
  (exports.h = preact_module.h),
    (exports.render = preact_module.render),
    (exports.Component = preact_module.Component),
    (exports.html = t);
});
